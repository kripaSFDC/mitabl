...
2. The public website also exposed integration proxy APIs (`/api/preregister`, `/api/support/ticket`) to forward intake requests into backend services.
...
2. Pre-register and support ticket intake removed from public website integration path:
