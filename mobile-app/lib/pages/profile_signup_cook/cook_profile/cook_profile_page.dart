...
class _CookProfilePage extends State<CookProfilePage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GlassAppBar(title: const Text('Become a miCook')),
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    MitablCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Showcase your cooking space (up to 5 photos)',
                            style: TextStyle(
                              fontSize: 13,
                              color: MitablColors.onSurfaceVariant,
                            ),
                    ...
                    MitablCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'Set your kitchen opening days and hours',
                            style: TextStyle(
                              fontSize: 13,
                              color: MitablColors.onSurfaceVariant,
                            ),
                    ...
                    // ── Dine-in Slots ──
                    MitablCard(
                      child: const _CreateKitchenSlotSection(),
                    ),
                    const SizedBox(height: MitablSpacing.listItem),
      ...
      builder: (context, state) {
        return Column(
          children: [
            ...
            const Divider(height: 1, color: MitablColors.outlineVariant),
            Row(
              children: [
                Expanded(
                  child: Text(
