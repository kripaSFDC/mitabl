      ...
      builder: (context, state) {
        return Dialog(
          ...
          child: Container(
            ...
            padding: EdgeInsets.all(config.AppConfig(context).appWidth(1)),
            child: Column(
              ...
              children: [
                ...
                Slider(
                  ...
                  onChanged: (value) {
                    context.read<HomeCubit>().onDistanceChanged(
                      distance: value,
                    );
                  },
                  min: 1,
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: InkWell(
                          onTap: () {
                            context.read<HomeCubit>().onRoleChanged(
                              role: AppConstants.DINE_IN,
                            );
                          },
                          child: Container(
                            alignment: Alignment.center,
                ...
                SizedBox(height: config.AppConfig(context).appHeight(6)),
                const ApplyButton(),
                const Spacer(),
              ],
            ),
