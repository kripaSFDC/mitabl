...
<div class="mb-6 rounded-xl border border-blue-200 bg-blue-50 px-5 py-4 dark:border-blue-800 dark:bg-blue-950/30">
    <div class="flex gap-3">
        <x-filament::icon icon="heroicon-o-information-circle" class="h-5 w-5 flex-shrink-0 text-blue-500 mt-0.5" />
    ...
    <div class="border-b border-gray-200 bg-gray-50 px-5 py-3 dark:border-gray-700 dark:bg-gray-800">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Validated requests require a second admin ✓ before activation</p>
            </div>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @foreach ($pendingApprovals as $request)
                        ...
                        <tr class="bg-white hover:bg-gray-50/80 dark:bg-gray-900 dark:hover:bg-gray-800/50 transition-colors">
                            ...
                            <td class="px-5 py-3 text-gray-600 dark:text-gray-300 max-w-xs">
