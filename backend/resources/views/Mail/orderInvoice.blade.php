...
<body style="max-width: 600px;margin:  0 auto; box-sizing: border-box;font-family: itc-avant-garde-gothic-pro, sans-serif;">
    <div style="width: 100%;float:  left;background-color: #86c2e9;padding: 50px 50px 50px; box-sizing: border-box;">
        <div style="background-color:#fff;text-align: center;width: 100%;float:left;padding: 20px 0 0; box-sizing: border-box; color: #707070;">
            <img src="{{url('frontend/images/logo.png')}}" style="width: 100px;" />
            <h2 style="font-size: 31px;font-weight: 800;margin: 30px 0 50px;">Order Reciept</h2>
            <h5 style="font-size: 18px;font-weight: 600;margin-top: 20px;">Thank you  @if($customer) for ordering from {{ $order->Mikitchn->name}} @else {{ $order->Mikitchn->name}}  for complete order @endif</h5>
            ...
            <div class="order-head" style="width: 100%; float: left; padding: 0 40px; box-sizing: border-box;">
                ...
                <p style="width: 50%; float: left; text-align: right; line-height: 22px;">{{$order->completedorder->completed_date_time}}</p>
            </div>
        ...
        <footer style="background-color: #0071bc;width: 100%;float: left;text-align: center;padding: 10px 0">
            ...
            <div style="width: 100%;float:left;">
                <a href="https://mitabl.xcelanceweb.com/#" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: right;"><img src="{{url('frontend/images/google.png')}}" style="width:100%;max-width: 160px;margin-right: 10px;"></a>
                <a href="https://mitabl.xcelanceweb.com/#" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: left;"><img src="{{url('frontend/images/app.png')}}" style="width:100%;max-width: 160px;margin-left: 10px;"></a>
            </div>
