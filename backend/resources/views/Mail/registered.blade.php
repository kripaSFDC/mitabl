...
<body style="max-width: 600px;margin:  0 auto;box-sizing: border-box;font-family: itc-avant-garde-gothic-pro, sans-serif;">
    <div style="width: 100%;float:  left;background-color: #86c2e9;padding: 50px 50px 50px;">
        <div style="background-color:#fff;text-align: center;width: 100%;float:left;padding: 20px 0 0;color: #707070;">
            ...
            <h2 style="font-size: 31px;font-weight: 800;margin: 30px 0 50px;">Hello {{$user->first_name.' '.$user->last_name}} Welcome to mitabl!</h2>
        ...
        <footer style="background-color: #0071bc;width: 100%;float: left;text-align: center;padding: 10px 0">
            ...
            <div style="width: 100%;float:left;">
                <a href="https://mitabl.com" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: right;"><img src="{{url('frontend/images/google.png')}}" style="width:100%;max-width: 160px;margin-right: 10px;"></a>
                <a href="https://mitabl.com" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: left;"><img src="{{url('frontend/images/app.png')}}" style="width:100%;max-width: 160px;margin-left: 10px;"></a>
            </div>
