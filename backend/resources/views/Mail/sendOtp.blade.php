...
<body style="max-width: 600px;margin:  0 auto;box-sizing: border-box;font-family: itc-avant-garde-gothic-pro, sans-serif;">
    <div style="width: 100%;float:  left;background-color: #86c2e9;padding: 50px 50px 50px;">
        ...
        <footer style="background-color: #0071bc;width: 100%;float: left;text-align: center;padding: 10px 0">
            ...
            <div style="width: 100%;float:left;">
                <a href="#" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: right;"><img src="https://mitabl.com/frontend/images/google.png" style="width:100%;max-width: 160px;margin-right: 10px;"></a>
                <a href="#" data-toggle="modal" data-target="#myModal" style="width: 50%;float:left;text-align: left;"><img src="https://mitabl.com/frontend/images/app.png" style="width:100%;max-width: 160px;margin-left: 10px;"></a>
            </div>
