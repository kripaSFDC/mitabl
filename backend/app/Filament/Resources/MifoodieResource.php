...
use App\Filament\Resources\MifoodieResource\Pages;
use App\Models\User;
...
class MifoodieResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Mifoodie';

    protected static ?string $pluralModelLabel = 'Mifoodies';
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('soft_delete')
                    ...
                    ->action(function (User $record, array $data): void {
                        ...
                        Notification::make()
                            ->title($deleted ? 'Mifoodie soft deleted successfully.' : 'Mifoodie could not be deleted.')
                ...
                Tables\Actions\Action::make('restore')
                    ...
                    ->action(function (User $record, array $data): void {
                        ...
                        Notification::make()
                            ->title($restored ? 'Mifoodie restored successfully.' : 'Mifoodie could not be restored.')
    ...
    {
        return [
            'index' => Pages\ListMifoodies::route('/'),
            'create' => Pages\CreateMifoodie::route('/create'),
            'edit' => Pages\EditMifoodie::route('/{record}/edit'),
        ];
    }
